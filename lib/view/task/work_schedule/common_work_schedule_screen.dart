...
import 'package:manage_app/view/task/work_schedule/common_work_shift_widget.dart';
...
class CommonWorkScheduleScreen extends StatefulWidget {
  const CommonWorkScheduleScreen({super.key});

  @override
  State<CommonWorkScheduleScreen> createState() => _CommonWorkScheduleScreenState();
}

class _CommonWorkScheduleScreenState extends State<CommonWorkScheduleScreen> {
