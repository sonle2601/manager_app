                  ...
                  employeeVM.employeeAccept.isNotEmpty
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        print(employeeVM.employeeAccept[index].information!.hoTen.toString());
                        return Column(
                          children: [
                            Container(
                              ...
                              onTap: () {
                                setModalState(() {
                                  ...
                                  if (selectedId == employeeId) {
                                    ...
                                    selectedName = employeeVM.employeeAccept[index].information!.hoTen.toString();
                                  }
                                });
                              },
                              child: Container(
