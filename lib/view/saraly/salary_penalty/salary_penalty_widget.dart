...
class SalaryPenaltyWidget extends StatelessWidget {
  final String employeeName;
  final String amount;
  final String reason;
  final String date;
  final VoidCallback? onTap;
  const SalaryPenaltyWidget({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 5,),
            AppText(text: "Số tiền phạt ${FormatUtils.formatNumberWithCommas(amount.toString())}"),
            SizedBox(height: 5,),
